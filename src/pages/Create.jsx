...
function Create() {
    ...
    const handleSendData = async () => {
        ...
        try{
            const resUser = await axios.post('http://185.25.118.136:5000/user/getUserByTelegramId', {telegramId: user?.id})
            const adv = {
            ...
            await axios.post('http://185.25.118.136:5000/advertisement/create',adv)
