...
function Create() {
    ...
    const handleSendData = async () => {
        ...
        try{
            const resUser = await axios.post('https://ligabotv2-production.up.railway.app/user/getUserByTelegramId', {telegramId: user?.id})
            const adv = {
            ...
            await axios.post('https://ligabotv2-production.up.railway.app/advertisement/create',adv)
