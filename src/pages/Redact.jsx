...
function Redact() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const res = await axios.get('https://ligabotv2-production.up.railway.app/city/findAll')
                const adv = await axios.post('https://ligabotv2-production.up.railway.app/advertisement/findById',{advertisementId})
    ...
    const handleSendData = async () => {
        try{
            ...
            const res = await axios.put('https://ligabotv2-production.up.railway.app/advertisement/redact',{advertisementId,data:adv})
