...
function Redact() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const res = await axios.get('http:185.25.118.136:5000/city/findAll')
                const adv = await axios.post('http:185.25.118.136:5000/advertisement/findById',{advertisementId})
    ...
    const handleSendData = async () => {
        try{
            ...
            const res = await axios.put('http:185.25.118.136:5000/advertisement/redact',{advertisementId,data:adv})
